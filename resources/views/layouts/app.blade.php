...
<body class="font-brand pb-16 text-gray-700 m-0">



    <header class="">
        <div class="container max-w-5xl flex justify-between mx-auto pb-0 md:pb-3 pt-3 px-3 md:px-0">
            <a href="/" class="flex justify-center items-center flex-shrink-0 mr-6 no-underline">
            ...
            <a href="mailto:{{ config('me.email') }}?Subject=GITWTF: Post Submission" class="pl-2 sm:pl-6 sm:pr-4 py-3 md:py-6 flex-none flex items-center no-underline hover:text-black">

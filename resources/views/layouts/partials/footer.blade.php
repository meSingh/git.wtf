...
<section class="newsletter bg-gray-100 py-16 px-4 md:px-8 border-t border-gray-300">
    <div class="max-w-screen-lg px-2 md:px-12  mx-auto">
        ...
        <form action="https://khurafatstudio.us13.list-manage.com/subscribe/post?u=00058058733c668eea4891e02&amp;id=d83f6d4784" method="post" class="flex flex-col md:flex-row flex-wrap">
            <input type="email" placeholder="Enter your email address..." name="EMAIL" class="bg-white px-4 py-2 w-full md:w-3/4 focus:outline-none appearance-none border-transparent text-base mr-4 mb-4 md:mb-0 border border-solid border-gray-300 rounded">
            <input type="hidden" name="LOCATION" value="GIT.WTF!?!">
            <button type="submit" class="bg-brand hover:bg-gray-900 flex-1 text-white py-4 font-semibold rounded inline-block no-underline border-none text-base cursor-pointer mr-4 md:mr-0">Sign me up!</button>
        </form>
    </div>
</section>
    ...
    <div class="links mt-8 md:mt-0">
        <div class="links mt-0 md:text-right" style="">
            <p class="inline-block">
                You can blame <a href="https://www.msingh.com" data-turbolinks="false" target="_blank" class="text-red-400 hover:text-red-500 font-bold">Mandeep Singh</a> & <a href="/contributors" class="text-teal-400 hover:text-teal-500 font-bold">Contributors</a> for this
            </p>
            <p class="text-base">The website content is licensed <a href="http://creativecommons.org/licenses/by-nc-sa/4.0/" class="text-blue-400 hover:text-blue-500">CC BY NC SA 4.0</a>.
      </p>
